...
public class Constants {
    ...
    public static final String TRAININGCENTER = "trainingcenter";
    public static final String INVALID_MOBILE_NUMBER = "Invalid mobile number";
    public static final String MOBILE_MATCH = "(0/91)?[7-9][0-9]{9}";
    ...
    public static final String TRAININGCENTER_ADDRESSES = "trainingcenter_addresses";
    public static final String TRAININGCENTER_UUID = "trainingcenter_uuid";
